...
LongDescription=['Ambulance service, outside state per mile, transport (medicaid only)','Enteral feeding supply kit; syringe fed, per day, includes but not limited to feeding/flushing syringe,administration set tubing, dressings, tape','Hemostatic agent, gastrointestinal, topical','Cellular therapy','Administration of influenza virus vaccine','Administration of influenza virus vaccine','Alcohol and/or drug assessment','Injection, tetracycline, up to 250 mg','	Standard wheelchair','Cervical, semi-rigid, adjustable (plastic collar)','Medical Services','Cellular therapy','Cephalin floculation, blood','Cardiokymography','Transportation of portable ekg to facility or location, per patient','Exemestane, 25 mg','Nursing assessment / evaluation','Cdc 2019 novel coronavirus (2019-ncov) real-time rt-pcr diagnostic panel',	'Frames, purchases']
